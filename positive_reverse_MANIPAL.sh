...
read -p "Enter Name of the Reverse .ab1 file relevant to the $reference Reference Gene file : " ABI
if [ -f "$ABI" ] && [ "$ABI" != " " ]
then
echo "The entered Reverse ABI filename is $ABI."
else
until [ -f "$ABI" ] && [ "$ABI" != " " ]
do
echo "The ABI file cannot be empty and is required by the MANIPAL System."
echo "Please provide the correct Reverse ABI file relevant to the $reference Reference Gene file : "
read ABI
done
fi
...
# II) If gene is on Positive STRAND! 

# B- BLAST for 'REVERSE ABI file'
...
while true; do
    ...
    case $yn in
        ...
        [Nn]* ) echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Finished Reverse ABI file processing! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"; exit;;
